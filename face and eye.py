...
# images. 
face_cascade = cv2.CascadeClassifier('C:\\Users\\Agast\\Downloads\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt2.xml') 
...
while 1: 
	...
	for (x,y,w,h) in faces: 
		...
		cv2.rectangle(img,(x,y),(x+w,y+h),(0, 132, 255),1) 
